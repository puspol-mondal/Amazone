  ...
  return (
    <div className=" max-w-screen-2xl mx-auto px-6 grid grid-cols-5 gap-10 py-4">
      {productData.length > 0 ? (
        <>
          <div className=" bg-white col-span-4 grid p-4 rounded-lg">
            <div className=" flex items-center justify-between border-b-[1px] border-b-gray-400 pb-1">
              <p className=" text-2xl font-semibold text-amazone_blue">
                Shopping cart
              </p>
        ...
        <div className=" bg-white h-64 col-span-5 flex flex-col items-center justify-center py-5 rounded-lg shadow-lg">
          ...
          <Link href={"/"}>
            <button
              className=" w-52 h-10 bg-amazone_blue text-white rounded-lg text-sm font-semibold hover:bg-amazone_yellow hover:text-black
             "
            >
              Go to shopping
            </button>
